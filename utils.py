...
def calculate_rank(qr_count_30d: int) -> Tuple[str, float]:
    if qr_count_30d >= 60:
        return "Элита", 1.0
...
def calculate_regularity_points(active_days_30: int) -> float:
    if active_days_30 >= 30:
        return 4
    elif active_days_30 >= 26:
        return 3.5
    elif active_days_30 >= 21:
        return 3
    elif active_days_30 >= 16:
        return 2.5
    elif active_days_30 >= 11:
        return 2
    elif active_days_30 >= 6:
        return 1.5
    elif active_days_30 >= 1:
        return 1
    else:
        return 0
